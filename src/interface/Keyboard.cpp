...
const std::array<std::string_view, static_cast<size_t>(KeyCode::Count)>
    kKeyNames = {
        "A ",      "B",        "C",        "D",         "E",
        "F",       "G",        "H",        "I",         "J",
        "K",       "L",        "M",        "N",         "O",
...
std::string_view keyName(KeyCode code) {
  return kKeyNames[static_cast<size_t>(code)];
}
